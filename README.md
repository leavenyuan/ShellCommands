...
#### grep只返回符合特定pattern的内容
`cat 666aa2ce55bbded2df3a987c.json | grep -o '17136091677.., "tfl_pass_state": "[0-9]\+"'`
```sh
返回:
1713609167737, "tfl_pass_state": "00000000444000000000000"
1713609167785, "tfl_pass_state": "00000000444000000000000"
```
